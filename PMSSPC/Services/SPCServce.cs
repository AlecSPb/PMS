...
namespace PMSSPC.Services
{
    public class SPCServce
    {
        ...
        public List<RecordTestModel> GetRecordTestModelsDensity(string composition,string start,string end)
        {
        ...
        {
            var data = GetRecordTestModelsDensity(composition,start,end);

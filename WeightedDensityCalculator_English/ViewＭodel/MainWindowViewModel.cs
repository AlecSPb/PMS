...
namespace WeightedDensityCalculator.ViewＭodel
{
    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            SelectedCalculationSubstance = new CalculationSubstance() { ElementName = "Null" };
        ...
        private bool CanAdd()
        {
            if (SelectedCalculationSubstance.ElementName == "Null" || string.IsNullOrEmpty(SelectedCalculationSubstance.ElementName))
            {
                return false;
            }
            return true;

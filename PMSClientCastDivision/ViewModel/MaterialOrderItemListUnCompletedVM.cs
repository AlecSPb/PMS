...
namespace PMSClient.ViewModel
{
    public class MaterialOrderItemListUnCompletedVM : BaseViewModelPage
    {
        ...
        private void SetPageParametersWhenConditionChange()
        {
            ...
            RecordCount = service.GetMaterialOrderItemExtrasUnCompletedCount(SearchComposition, SearchPMINumber, SearchOrderItemNumber);
            service.Close();
            ActionPaging();
        }
        /// <summary>
        ...
        private void ActionPaging()
        {
            ...
            take = PageSize;
            var service = new SanjieServiceClient();
            var orders = service.GetMaterialOrderItemExtrasUnCompleted(skip, take, SearchComposition, SearchPMINumber, SearchOrderItemNumber);
            service.Close();

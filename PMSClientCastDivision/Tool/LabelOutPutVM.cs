...
namespace PMSClient.Tool
{
    public class LabelOutPutVM : ViewModelBase
    {
        ...
        private void ActionOpenFile()
        {
            try
            {
                var filepath = Path.Combine(Environment.CurrentDirectory, "Resource", "DocTemplate", "BarTender101", TemplateFileName+".btw");
                var targetpath = Path.Combine(Environment.CurrentDirectory, "Resource", "DocTemplate", "BarTender101", TemplateFileName+"_temp.btw");

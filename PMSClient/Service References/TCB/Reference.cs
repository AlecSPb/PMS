...
namespace PMSClient.TCB {
    ...
    public interface ITCBService {
        ...
        PMSClient.TCB.DcDeliveryItemTCB[] GetDeliveryItemTCB(int s, int t, string productid, string composition, string po, string customer, string bondingpo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITCBService/GetDeliveryItemTCB", ReplyAction="http://tempuri.org/ITCBService/GetDeliveryItemTCBResponse")]
        System.Threading.Tasks.Task<PMSClient.TCB.DcDeliveryItemTCB[]> GetDeliveryItemTCBAsync(int s, int t, string productid, string composition, string po, string customer, string bondingpo);
        ...
        void AddDeliveryItemTCB(PMSClient.TCB.DcDeliveryItemTCB model);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITCBService/AddDeliveryItemTCB", ReplyAction="http://tempuri.org/ITCBService/AddDeliveryItemTCBResponse")]
        System.Threading.Tasks.Task AddDeliveryItemTCBAsync(PMSClient.TCB.DcDeliveryItemTCB model);
        ...
        void UpdateDeliveryItemTCB(PMSClient.TCB.DcDeliveryItemTCB model);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITCBService/UpdateDeliveryItemTCB", ReplyAction="http://tempuri.org/ITCBService/UpdateDeliveryItemTCBResponse")]
        System.Threading.Tasks.Task UpdateDeliveryItemTCBAsync(PMSClient.TCB.DcDeliveryItemTCB model);
        ...
        PMSClient.TCB.DcDelivery[] GetDelivery(int s, int t, string deliveryname);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITCBService/GetDelivery", ReplyAction="http://tempuri.org/ITCBService/GetDeliveryResponse")]
        System.Threading.Tasks.Task<PMSClient.TCB.DcDelivery[]> GetDeliveryAsync(int s, int t, string deliveryname);
        ...
        PMSClient.TCB.DcDeliveryItemTCB[] GetDeliveryItemTCBByDeliveryID(System.Guid id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITCBService/GetDeliveryItemTCBByDeliveryID", ReplyAction="http://tempuri.org/ITCBService/GetDeliveryItemTCBByDeliveryIDResponse")]
        System.Threading.Tasks.Task<PMSClient.TCB.DcDeliveryItemTCB[]> GetDeliveryItemTCBByDeliveryIDAsync(System.Guid id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ITCBServiceChannel : PMSClient.TCB.ITCBService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TCBServiceClient : System.ServiceModel.ClientBase<PMSClient.TCB.ITCBService>, PMSClient.TCB.ITCBService {
        ...
        public PMSClient.TCB.DcDeliveryItemTCB[] GetDeliveryItemTCB(int s, int t, string productid, string composition, string po, string customer, string bondingpo) {
            return base.Channel.GetDeliveryItemTCB(s, t, productid, composition, po, customer, bondingpo);
        }
        
        public System.Threading.Tasks.Task<PMSClient.TCB.DcDeliveryItemTCB[]> GetDeliveryItemTCBAsync(int s, int t, string productid, string composition, string po, string customer, string bondingpo) {
        ...
        public void AddDeliveryItemTCB(PMSClient.TCB.DcDeliveryItemTCB model) {
            base.Channel.AddDeliveryItemTCB(model);
        }
        
        public System.Threading.Tasks.Task AddDeliveryItemTCBAsync(PMSClient.TCB.DcDeliveryItemTCB model) {
            return base.Channel.AddDeliveryItemTCBAsync(model);
        }
        
        public void UpdateDeliveryItemTCB(PMSClient.TCB.DcDeliveryItemTCB model) {
            base.Channel.UpdateDeliveryItemTCB(model);
        }
        
        public System.Threading.Tasks.Task UpdateDeliveryItemTCBAsync(PMSClient.TCB.DcDeliveryItemTCB model) {
            return base.Channel.UpdateDeliveryItemTCBAsync(model);
        }
        
        public PMSClient.TCB.DcDelivery[] GetDelivery(int s, int t, string deliveryname) {
            return base.Channel.GetDelivery(s, t, deliveryname);
        }
        
        public System.Threading.Tasks.Task<PMSClient.TCB.DcDelivery[]> GetDeliveryAsync(int s, int t, string deliveryname) {
        ...
        public PMSClient.TCB.DcDeliveryItemTCB[] GetDeliveryItemTCBByDeliveryID(System.Guid id) {
            return base.Channel.GetDeliveryItemTCBByDeliveryID(id);
        }
        
        public System.Threading.Tasks.Task<PMSClient.TCB.DcDeliveryItemTCB[]> GetDeliveryItemTCBByDeliveryIDAsync(System.Guid id) {

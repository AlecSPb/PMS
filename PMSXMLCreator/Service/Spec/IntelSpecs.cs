...
namespace PMSXMLCreator.Service
{
    ...
    public class IntelSpecs:ISpecs
    {
        ...
        private void Init()
        {
            ...
            parameters.Add("BP Flange Thickness", new SpecModel { ShortName = "BP_FTHK", LCL = 15.5, UCL = 16.5, UnitOfMeasure = ParameterUnit.MM });
            ...
            parameters.Add("Aluminum", new SpecModel { ShortName = "ZAL", LCL = 0, UCL = 2.8, UnitOfMeasure = ParameterUnit.PPM});
            ...
            parameters.Add("Iron", new SpecModel { ShortName = "IA", LCL = 0, UCL = 4.2, UnitOfMeasure = ParameterUnit.PPM });
            ...
            parameters.Add("Nickel", new SpecModel { ShortName = "ZNI", LCL = 0, UCL = 10, UnitOfMeasure = ParameterUnit.PPM });

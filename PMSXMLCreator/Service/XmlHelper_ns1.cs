...
namespace PMSXMLCreator.Service
{
    ...
    public class XmlHelper_ns1 : IXmlHelper
    {
        ...
        private void AddMaterialParameter(XmlWriter writer, Parameter p)
        {
            ...
            //    writer.WriteElementString(ns_prefix,"UCL", item.UCL, ns);
            //    writer.WriteElementString(ns_prefix,"LCL", item.LCL, ns);
            //    writer.WriteElementString(ns_prefix,"MDL", item.MDL, ns);
